...
const messages = defineMessages({
  ...
  metaDescription: {
    ...
    defaultMessage:
      'At Planner.so, we are dedicated to safeguarding your privacy. This policy explains the information we collect, how we use it, and your rights regarding that information.',
  },
})
