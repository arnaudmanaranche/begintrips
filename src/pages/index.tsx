...
export default function HomePage({ user }: { user: User }) {
  ...
  return (
    <main>
      ...
      <section className="relative z-10 h-[calc(100vh-20rem)] bg-accent-light/20 md:overflow-hidden">
        <div className="mx-auto flex max-w-screen-xl flex-col justify-start space-y-16 pt-10">
          ...
          <div className="absolute bottom-[-200px] left-0 right-0 ml-auto mr-auto flex w-[calc(100%-2rem)] flex-col space-x-0 rounded-2xl bg-white shadow-lg md:relative md:bottom-0 md:ml-10 md:mr-0 md:w-fit md:flex-row md:space-x-10 xl:ml-0">
